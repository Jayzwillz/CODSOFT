document.addEventListener("DOMContentLoaded", () => {
    ...
    buttons.addEventListener("click", (event) => {
      ...
      } else if (target.classList.contains("button-number")) {
        handleNumber(target.dataset.number);
      } else if (target.classList.contains("button-decimal")) {
        handleDecimal();
      } else if (target.classList.contains("button-clear")) {
        clear();
      } else if (target.classList.contains("button-equals")) {
        handleEquals();
